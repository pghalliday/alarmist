...
var createJob = exports.createJob = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(_ref) {
    ...
    var name = _ref.name;
    var jobDir, idFile, id, reportDir, statusFile, startTime, log, logStream, logStreamEnded, controlConnection, controlReady, controlEnded, logConnection, logReady, logEnded;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 12:
            ...
            controlConnection = (0, _net.createConnection)((0, _localSocket.getControlSocket)());
          ...
          case 25:
            ...
            logConnection = (0, _net.createConnection)((0, _localSocket.getLogSocket)());
