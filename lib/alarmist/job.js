...
var createJob = exports.createJob = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(_ref) {
    ...
    var group = _ref.group,
        name = _ref.name;
    var id, reportDir, statusFile, startTime, stdout, stderr, stdoutStream, stderrStream, allStream, stdoutStreamEmit, stdoutEmit, streamEndPromises;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            id = _uuid2.default.v1();
            reportDir = _path2.default.join(_constants.WORKING_DIR, group, name, id);
          ...
          case 8:
            ...
            stdoutStreamEmit = stdoutStream.emit.bind(stdoutStream);

            stdoutStream.emit = function () {
              stdoutStreamEmit.apply(undefined, arguments);
            };
            stdoutEmit = stdout.emit.bind(stdout);

            stdout.emit = function () {
              stdoutEmit.apply(undefined, arguments);
            };
