...
var getControlSocket = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(workingDir, server) {
    var controlSocket;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            controlSocket = _path2.default.join(workingDir, _constants.CONTROL_SOCKET);
            _context2.next = 3;
  ...
  return function getControlSocket(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

var getLogSocket = function () {
  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(workingDir, server) {
    var logSocket;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            logSocket = _path2.default.join(workingDir, _constants.LOG_SOCKET);
            _context3.next = 3;
  ...
  return function getLogSocket(_x5, _x6) {
...
var pwriteFile = (0, _promisify2.default)(_fs.writeFile);exports.getControlSocket = getControlSocket;
