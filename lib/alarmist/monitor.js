...
var createMonitor = exports.createMonitor = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(_ref) {
    ...
    var monitor, groupDir;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            monitor = new _events2.default();
            groupDir = _path2.default.join(_constants.WORKING_DIR, group);
            _context2.next = 4;
            return rimraf(groupDir);

          case 4:
            _context2.next = 6;
            return mkdirp(groupDir);

          case 6:
            return _context2.abrupt('return', new Promise(function (resolve) {
              var watcher = _chokidar2.default.watch(groupDir + '/**').on('ready', resolve.bind(null, monitor)).on('all', function () {
                var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(event, filePath) {
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        ...
                        case 7:
                          ...
                          _context.next = _context.t0 === _constants.STATUS_PENDING ? 12 : _context.t0 === _constants.STATUS_COMPLETE ? 14 : 28;
                          break;
                        ...
                        case 14:
                          reportDir = _path2.default.join(groupDir, name, id);
                          _context.next = 17;
