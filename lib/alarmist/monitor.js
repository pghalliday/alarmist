...
var createMonitor = exports.createMonitor = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
    ...
    var monitor, log, logStream, logStreamEnded, endLogStream, controlServer, controlListen, controlClose, logServer, logListen, logClose;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            _context4.next = 15;
            return controlListen((0, _localSocket.getControlSocket)());
          ...
          case 15:
            ...
            _context4.next = 20;
            return logListen((0, _localSocket.getLogSocket)());
