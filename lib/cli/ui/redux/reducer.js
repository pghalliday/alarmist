...
}), _defineProperty(_handleActions, _actions.monitorLog, function (monitor, _ref2) {
...
var jobs = (0, _reduxActions.handleActions)((_handleActions2 = {}, _defineProperty(_handleActions2, _actions.reset, function () {
  return initialJobs;
}), _defineProperty(_handleActions2, _actions.start, function (jobs, _ref3) {
...
}), _defineProperty(_handleActions2, _actions.jobLog, function (jobs, _ref4) {
  ...
  return jobs;
}), _defineProperty(_handleActions2, _actions.end, function (jobs, _ref5) {
...
}), _defineProperty(_handleActions3, _actions.start, function (layout, _ref6) {
