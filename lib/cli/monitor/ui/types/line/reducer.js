...
exports.lineEnd = exports.lineValue = exports.lineAdvance = exports.lineColors = exports.lineStart = undefined;
...
var _createActions = (0, _reduxActions.createActions)('LINE_START', 'LINE_COLORS', 'LINE_ADVANCE', 'LINE_VALUE', 'LINE_END'),
    lineStart = _createActions.lineStart,
    lineColors = _createActions.lineColors,
...
var INITIAL_COLORS = ['white', 'yellow', 'blue', 'green', 'cyan', 'purple', 'orange', 'red'];
...
function createReducer(name, type) {
  ...
  var colorsSelector = function colorsSelector(state) {
    return state.colors;
  };
  ...
  var dataSelector = (0, _reselect.createSelector)(seriesSelector, xSelector, colorsSelector, function (series, x, colors) {
    var data = [];
  ...
  return (0, _reduxActions.handleActions)((_handleActions = {}, _defineProperty(_handleActions, lineStart, function (state, _ref) {
  ...
  }), _defineProperty(_handleActions, lineColors, function (state, _ref2) {
  ...
  }), _defineProperty(_handleActions, lineAdvance, function (state, _ref3) {
  ...
  }), _defineProperty(_handleActions, lineValue, function (state, _ref4) {
    ...
    return (0, _reducer.check)(_reducer.eq, state, payload, function () {
      if (state.x.length) {
        ...
        var values = appendValue(series.values, payload.value, state.x.length);
  ...
  }), _defineProperty(_handleActions, lineEnd, function (state, _ref5) {
