...
var defaultDebug = (0, _optionDefault2.default)(_constants.DEBUG_VAR, _constants.DEFAULT_DEBUG_OPTION, toBool);
...
var defaultName = (0, _optionDefault2.default)(_constants.MONITOR_NAME_VAR, _constants.DEFAULT_MONITOR_NAME);
...
function parse(argv) {
  ...
  if (parsed['name'] instanceof Array) {
    return {
      error: _constants.MULTIPLE_NAMES_ERROR
    };
  }
