        ...
        describe('common', () => {
          describe('view', () => {
            describe('Log', () => {
              ...
              after(() => {
                Entry.prototype.setParent.restore();
                Entry.prototype.update.restore();
                Entry.prototype.layout.restore();
                Entry.prototype.collapse.restore();
                Entry.prototype.expand.restore();
                Entry.prototype.focus.restore();
              });
              ...
              describe('when the log is shift right clicked', () => {
                ...
                // eslint-disable-next-line max-len
                it('should copy text without control sequences to clipboard', () => {
                  copyPaste.copy.should.have.been.calledWith(
                    helper.TEST_CONTENT
                  );
                });
              });
              ...
              describe('setParent', () => {
                ...
                it('should set the parent for super class', () => {
                  Entry.prototype.setParent.should.have.been.calledWith(
                    container
                  );
                });
